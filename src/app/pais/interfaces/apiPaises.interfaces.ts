...
export class Convert {
    public static toAPIPais(json: string): APIPais[] {
        return cast(JSON.parse(json), a(r("APIPais")));
    }

    public static aPIPaisToJson(value: APIPais[]): string {
        return JSON.stringify(uncast(value, a(r("APIPais"))), null, 2);
    }
}
